...
extension Terminal.StyledFragment {
  fileprivate func appendingStyle(
    foreground: Terminal.Color? = nil, background: Terminal.Color? = nil,
    weight: Terminal.Weight? = nil, effects: Set<Terminal.Effect>? = nil,
    padding: Terminal.Padding? = nil
  ...
  public var black: Terminal.StyledFragment { appendingStyle(foreground: .black) }

  /// Returns a copy of the current fragment setting ANSI red as the foreground color.
  public var red: Terminal.StyledFragment { appendingStyle(foreground: .red) }

  /// Returns a copy of the current fragment setting ANSI green as the foreground color.
  public var green: Terminal.StyledFragment { appendingStyle(foreground: .green) }

  /// Returns a copy of the current fragment setting ANSI yellow as the foreground color.
  public var yellow: Terminal.StyledFragment { appendingStyle(foreground: .yellow) }

  /// Returns a copy of the current fragment setting ANSI blue as the foreground color.
  public var blue: Terminal.StyledFragment { appendingStyle(foreground: .blue) }

  /// Returns a copy of the current fragment setting ANSI magenta as the foreground color.
  public var magenta: Terminal.StyledFragment { appendingStyle(foreground: .magenta) }

  /// Returns a copy of the current fragment setting ANSI cyan as the foreground color.
  public var cyan: Terminal.StyledFragment { appendingStyle(foreground: .cyan) }
  ...
  public var white: Terminal.StyledFragment { appendingStyle(foreground: .white) }
  ...
  public var gray: Terminal.StyledFragment { appendingStyle(foreground: .gray) }
  ...
  /// - Returns: the modified copy.
  public func srgb(
    red: Terminal.SRGBColor.Component, green: Terminal.SRGBColor.Component,
    blue: Terminal.SRGBColor.Component
  ) -> Terminal.StyledFragment {
  ...
  public var onRed: Terminal.StyledFragment { appendingStyle(background: .red) }

  /// Returns a copy of the current fragment setting ANSI green as the background color.
  public var onGreen: Terminal.StyledFragment { appendingStyle(background: .green) }

  /// Returns a copy of the current fragment setting ANSI yellow as the background color.
  public var onYellow: Terminal.StyledFragment { appendingStyle(background: .yellow) }

  /// Returns a copy of the current fragment setting ANSI blue as the background color.
  public var onBlue: Terminal.StyledFragment { appendingStyle(background: .blue) }

  /// Returns a copy of the current fragment setting ANSI magenta as the background color.
  public var onMagenta: Terminal.StyledFragment { appendingStyle(background: .magenta) }

  /// Returns a copy of the current fragment setting ANSI cyan as the background color.
  public var onCyan: Terminal.StyledFragment { appendingStyle(background: .cyan) }
  ...
  public var onWhite: Terminal.StyledFragment { appendingStyle(background: .white) }

  /// Returns a copy of the current fragment setting ANSI bright black as the background color.
  public var onGray: Terminal.StyledFragment { appendingStyle(background: .gray) }
  ...
  public func color(_ color: Terminal.Color, at layer: Terminal.Layer) -> Terminal.StyledFragment {
    switch layer {
    case .foreground: appendingStyle(foreground: color)
    case .background: appendingStyle(background: color)
    }
  }

  /// Returns a copy of the current fragment setting bold as the font weight.
  public var bold: Terminal.StyledFragment { appendingStyle(weight: .bold) }

  /// Returns a copy of the current fragment setting dim as the font weight.
  public var dim: Terminal.StyledFragment { appendingStyle(weight: .dim) }
  ...
  public var italic: Terminal.StyledFragment { appendingStyle(effects: [.italic]) }

  /// Returns a copy of the current fragment setting underline as an active effect.
  public var underline: Terminal.StyledFragment { appendingStyle(effects: [.underline]) }

  /// Returns a copy of the current fragment setting blinking as an active effect.
  public var blinking: Terminal.StyledFragment { appendingStyle(effects: [.blinking]) }

  /// Returns a copy of the current fragment setting inverted layers as an active effect.
  public var invertedLayers: Terminal.StyledFragment { appendingStyle(effects: [.invertedLayers]) }

  /// Returns a copy of the current fragment setting strikethrough as an active effect.
  public var strikethrough: Terminal.StyledFragment { appendingStyle(effects: [.strikethrough]) }
  ...
  /// - Returns: the modified copy.
  public func pad(
    _ alignment: Terminal.Alignment, with character: Character = " ", by length: Terminal.Size
  ) -> Terminal.StyledFragment {
