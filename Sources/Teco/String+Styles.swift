...
extension String {
  func rawPad(using padding: Terminal.Padding) -> String {
    ...
    case .left: return self + String(repeating: padding.character, count: count)
    case .right: return String(repeating: padding.character, count: count) + self
    case .center:
  ...
  public var white: Terminal.StyledFragment { .init(self, style: .init(foreground: .white)) }
  ...
  public var gray: Terminal.StyledFragment { .init(self, style: .init(foreground: .gray)) }
  ...
  public var onRed: Terminal.StyledFragment { .init(self, style: .init(background: .red)) }

  /// Creates a styled fragment from the current string setting ANSI green as the background color.
  public var onGreen: Terminal.StyledFragment { .init(self, style: .init(background: .green)) }

  /// Creates a styled fragment from the current string setting ANSI yellow as the background color.
  public var onYellow: Terminal.StyledFragment { .init(self, style: .init(background: .yellow)) }

  /// Creates a styled fragment from the current string setting ANSI blue as the background color.
  public var onBlue: Terminal.StyledFragment { .init(self, style: .init(background: .blue)) }

  /// Creates a styled fragment from the current string setting ANSI magenta as the background color.
  public var onMagenta: Terminal.StyledFragment { .init(self, style: .init(background: .magenta)) }

  /// Creates a styled fragment from the current string setting ANSI cyan as the background color.
  public var onCyan: Terminal.StyledFragment { .init(self, style: .init(background: .cyan)) }
  ...
  public var onWhite: Terminal.StyledFragment { .init(self, style: .init(background: .white)) }

  /// Creates a styled fragment from the current string setting ANSI bright black as the background color.
  public var onGray: Terminal.StyledFragment { .init(self, style: .init(background: .gray)) }
  ...
  public func color(_ color: Terminal.Color, at layer: Terminal.Layer) -> Terminal.StyledFragment {
    ...
    switch layer {
    case .foreground: style.foreground = color
    case .background: style.background = color
    }
    return .init(self, style: style)
  }

  /// Creates a styled fragment from the current string setting bold as the font weight.
  public var bold: Terminal.StyledFragment { .init(self, style: .init(weight: .bold)) }

  /// Creates a styled fragment from the current string setting dim as the font weight.
  public var dim: Terminal.StyledFragment { .init(self, style: .init(weight: .dim)) }
  ...
  public var italic: Terminal.StyledFragment { .init(self, style: .init(effects: [.italic])) }

  /// Creates a styled fragment from the current string setting underline as an active effect.
  public var underline: Terminal.StyledFragment { .init(self, style: .init(effects: [.underline])) }

  /// Creates a styled fragment from the current string setting blinking as an active effect.
  public var blinking: Terminal.StyledFragment { .init(self, style: .init(effects: [.blinking])) }
